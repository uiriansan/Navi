...
.load_stage2_loop:
    ...
    ;      HARDCODED     ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    add ax, 31                              ; first cluster = (stage2_cluster - 2) * sectors_per_cluster + start_sectors
...
;   - dh: head
;
;   See image b01 -> Storage Disk Layout
;   PART 2 -> https://www.youtube.com/watch?v=srbnMNk7K7k&list=PLFjM7v6KGMpiH2G-kT781ByCNC_0pKpPN&index=2
;
lba_to_chs:
    push ax
    push dx
...
.retry:
    ...
    jnc .done                           ; jump i carrry not set
